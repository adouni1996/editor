module.exports = {
  ...
  rules: { // html标签开始tag的关闭">"是否占一行
    'vue/html-closing-bracket-newline': [1, {
      'singleline': 'never',
      'multiline': 'always'
    }],
    // html标签多行内容时或者单行内容但标签有属性时换行格式
    ...
    'vue/max-attributes-per-line': [1, {
      'singleline': 6, // html标签中每行最大属性个数
      'multiline': 1 // html标签中要多行时的每行最大属性个数
    }],
    // 模板字符串中的嵌入表达式周围空格的使用
    'vue/template-curly-spacing': [1, 'always'],
    // vue组件命名规则，PascalCase：单词首字母要大写，kebab-case：单词首字母小写以-连接
